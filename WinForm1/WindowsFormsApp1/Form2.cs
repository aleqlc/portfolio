    ...
    public partial class Form2 : Form
    {
        ...
        private void button_save_Click(object sender, EventArgs e)//insert
        {
            ...
            string Query = "insert into opentutorials.topic_backup (author,title,description,profile,gender,DOB)" +
                            "value('" + this.textBox_author.Text + "','" + this.textBox_title.Text + "','" + this.textBox_description.Text + "','" + this.textBox_profile.Text + "','" + gender + "','" + this.dateTimePicker1.Text + "')";
        ...
        {
            string constring = "datasource = localhost; port=3306; username=root; password=root";
            string Query = "update opentutorials.topic_backup set author='" + this.textBox_author.Text + "',title='" + this.textBox_title.Text + "',description='" + this.textBox_description.Text + "',profile='" + this.textBox_profile.Text + "' where author='" + this.textBox_author.Text + "';";
            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand(Query, conDataBase);
            MySqlDataReader myReader;
        ...
        {
            string constring = "datasource = localhost; port=3306; username=root; password=root";
            string Query = "delete from opentutorials.topic_backup where author='" + this.textBox_author.Text+"';";
            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand(Query, conDataBase);
            MySqlDataReader myReader;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (myReader.Read())
                {
                    ...
                    this.textBox_author.Text = sAuthor;
                    this.textBox_title.Text = sTitle;
                    this.textBox_description.Text = sDescription;
                    this.textBox_profile.Text = sProfile;

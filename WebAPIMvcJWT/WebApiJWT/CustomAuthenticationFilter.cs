            ...
            (HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            if(authorization == null)
            {
                context.ErrorResult = new AuthenticationFailureResult
                    (reasonPhrase:"Missing Authorization Header", request);
                return;
            }
            ...
            {
                context.ErrorResult = new AuthenticationFailureResult
                    (reasonPhrase: "Invalid Authorization Schema", request);
                return;
            }
            ...
            {
                context.ErrorResult = new AuthenticationFailureResult
                    (reasonPhrase: "Missing Token", request);
                return;
            }
            ...
            {
                context.ErrorResult = new AuthenticationFailureResult
                    (reasonPhrase: "Invalid Token for User", request);
                return;
            }
            ...
            (HttpAuthenticationChallengeContext context, CancellationToken cancellationToken)
        {
            ...
            if (result.StatusCode == HttpStatusCode.Unauthorized)
            {
                result.Headers.WwwAuthenticate
                    .Add(new AuthenticationHeaderValue(scheme: "Basic", parameter: "realm=localhost"));
            }

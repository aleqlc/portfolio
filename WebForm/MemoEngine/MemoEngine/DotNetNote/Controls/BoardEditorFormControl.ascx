...
<table style="width:600px; border-collapse: collapse;
    ...
    <tr>
        ...
        <td style="width:500px;">
            ...
            <asp:RequiredFieldValidator ID="valName" runat="server"
                ErrorMessage="* 이름을 작성해 주세요." ControlToValidate="txtName" Display="None"
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtEmail" runat="server" MaxLength="80" Width="200px"
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtHomepage" runat="server" CssClass="form-control" 
                style="display:inline-block;" MaxLength="80" Width="300px"></asp:TextBox>
            <span style="color:#aaaaaa;font-style:italic;">(Optional)</span>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="valTitle" runat="server" 
                ErrorMessage="* 제목을 기입해 주세요." ControlToValidate="txtTitle" 
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="valContent" runat="server"
                ErrorMessage="* 내용을 기입해 주세요." ControlToValidate="txtContent"
                Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="valPassword" runat="server" 
                ErrorMessage="* 비밀번호를 기입해 주세요." ControlToValidate="txtPassword" 
                Display="None" SetFocusOnError="true"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <%
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtImageText" runat="server" CssClass="form-control" 
                style="display:inline-block;" EnableViewState="false" MaxLength="20"
    ...
    <tr>
        <td colspan="2" style="text-align:center;">
            <asp:Button ID="btnWrite" runat="server" Text="저장" CssClass="btn btn-primary"
                OnClick="btnWrite_Click" />
            <a href="BoardList.aspx" class="btn btn-default">리스트</a>
            <br />
            <asp:ValidationSummary ID="valSummary" runat="server" 
                ShowSummary="False" ShowMessageBox="true" DisplayMode="List" />
            <br />
        </td>
    </tr>
</table>
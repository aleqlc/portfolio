...
namespace EmployeeManager.Api.Controllers
{
    ...
    public class SecurityController : ControllerBase
    {
        ...
        private string GenerateJWT(string userName)
        {
            ...
            var token = new JwtSecurityToken(issuer: config["Jwt:Issuer"], audience: config["Jwt:Audience"], expires: DateTime.Now.AddHours(12), signingCredentials: credentials, claims: claims);
